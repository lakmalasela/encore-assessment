...
@section('content')
    ...
    <script>
        ...
        function toggleVariants(productId) {
            ...
            const toggleButton = document.querySelector('.product-row[data-product-id="' + productId + '"] .toggle-details');
            ...
            if (variantHeaderRow) {
                ...
                if (toggleButton) {
                    if (isHidden) {
                        ...
                        `;
                        toggleButton.setAttribute('title', 'View details');
                    }
                }
            }
        }
